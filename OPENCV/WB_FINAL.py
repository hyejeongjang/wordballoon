#mp4에서 mp3추출
#사람 얼굴 옆에 물풍선 추가, mp4 저장
#저장된 mp4와 추출한 mp3 합치기
import cv2
import numpy as np
import moviepy.editor as mp
from moviepy.editor import *
clip = mp.VideoFileClip('video_eng3.mp4')
clip.audio.write_audiofile("video_eng3.mp3")
...
cap = cv2.VideoCapture('video_eng3.mp4')
scaling_factor = 0.5
...
#out = cv2.VideoWriter(filename, fourcc, 25.0, (int(width), int(height)))
...
audioclip = AudioFileClip("video_eng3.mp3")
videoclip.audio = audioclip
videoclip.write_videofile("new_video_eng3.mp4")
